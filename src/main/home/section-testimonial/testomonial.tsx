    ...
    return (
        <figure className="relative">
            <svg viewBox="0 0 162 128" fill="none" aria-hidden="true"
                 className="absolute top-0 left-0 -z-10 h-14 stroke-amber-400">
            ...
            <blockquote className="p-4">
                <TextBig className="text-slate-700 font-medium">
                    {quote}
                </TextBig>
            </blockquote>
            <figcaption className="flex items-center p-4">
                <img src={thumbSrc} className="w-14 h-14 mr-4 rounded" />
                <div>
                    <TextRegular className="font-bold">{fullName}</TextRegular>
                    <TextRegular className="text-gray-500">{designation}</TextRegular>
                </div>
            </figcaption>
        </figure>
    );
